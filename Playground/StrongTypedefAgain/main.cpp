...
struct IndexOf_
{
    static constexpr int value =
        std::is_same<typename std::tuple_element<Index, Tuple>::type, El>::value
            ? Index
            : IndexOf_<El, Tuple, Index + 1, Size>::value;
};
...
public:
    static constexpr int value = Detail::IndexOf_<T, tuple_type, 0, tuple_size>::value;
};
...
struct HasDuplicates<Head, Next, Tail...>
{
    static constexpr bool value =
        ...
        IsAnyOf<Head, Tail...>::value ||
        IsAnyOf<Next, Tail...>::value;
};
