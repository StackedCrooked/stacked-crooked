...
{
public:
    // RequestHandler functor receives requests as strings and sends responses as strings.
...
public:
    ...
    // Sends a (blocking) request and returns the response received from the server.
