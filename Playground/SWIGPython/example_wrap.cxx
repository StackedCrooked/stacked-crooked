...
#define SWIGTYPE_p_std__vectorT_int_std__allocatorT_int_t_t swig_types[2]
...
SWIGINTERN PyObject *_wrap_sum(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "sum" "', argument " "1"" of type '" "std::vector< int,std::allocator< int > > const &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "sum" "', argument " "1"" of type '" "std::vector< int,std::allocator< int > > const &""'"); 
  }
  arg1 = reinterpret_cast< std::vector< int,std::allocator< int > > * >(argp1);
  result = (int)sum((std::vector< int,std::allocator< int > > const &)*arg1);
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
fail:
  return NULL;
