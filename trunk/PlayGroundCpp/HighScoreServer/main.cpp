...
public:
	...
	void handleRequest(HTTPServerRequest& request, HTTPServerResponse& response)
	{
		...
		ostr << "<html><head><title>HighScoreServer powered by POCO C++ Libraries</title>";
...
class HighScoreServer: public Poco::Util::ServerApplication
	...
	/// configuration files.
	/// Start the HighScoreServer executable with the help
	/// option (/help on Windows, --help on Unix) for
	/// the available command line options.
	///
	/// To use the sample configuration file (HighScoreServer.properties),
	/// copy the file to the directory where the HighScoreServer executable
	/// resides. If you start the debug version of the HighScoreServer
...
{
public:
	HighScoreServer(): _helpRequested(false)
	{
	}
...
protected:
	...
	int main(const std::vector<std::string>& args)
	{
		...
		else
		{
			...
			unsigned short port = (unsigned short) config().getInt("HighScoreServer.port", 9980);
			std::string format(config().getString("HighScoreServer.format", DateTimeFormat::SORTABLE_FORMAT));
